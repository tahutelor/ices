...
<head>
 ...
 ================================================== -->
  ...
  <link rel="stylesheet" href="<?php echo get_instance()->config->base_url()?>libraries/css/font-awesome.css">
...
<body>
  ...
  <h2 class="page-header">Every Font Awesome 4.1.0 Icon, CSS Class, &amp; Unicode</h2>
