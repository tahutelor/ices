...
$db['warehouse']['username'] = 'ices';
$db['warehouse']['password'] = 'Ices123';
$db['warehouse']['database'] = 'aryana_logistik_db';
$db['warehouse']['dbdriver'] = 'mysqli';
$db['warehouse']['dbprefix'] = '';
$db['warehouse']['pconnect'] = FALSE;
$db['warehouse']['db_debug'] = FALSE;
$db['warehouse']['cache_on'] = FALSE;
$db['warehouse']['cachedir'] = '';
$db['warehouse']['char_set'] = 'utf8';
$db['warehouse']['dbcollat'] = 'utf8_general_ci';
$db['warehouse']['swap_pre'] = '';
$db['warehouse']['autoinit'] = TRUE;
$db['warehouse']['stricton'] = FALSE;
$db['warehouse']['port'] = 3306;

$db['mini_warehouse']['hostname'] = 'localhost';
$db['mini_warehouse']['username'] = 'ices';
$db['mini_warehouse']['password'] = 'Ices123';
$db['mini_warehouse']['database'] = 'aryana_logistik_db';
$db['mini_warehouse']['dbdriver'] = 'mysqli';
$db['mini_warehouse']['dbprefix'] = '';
$db['mini_warehouse']['pconnect'] = FALSE;
$db['mini_warehouse']['db_debug'] = FALSE;
$db['mini_warehouse']['cache_on'] = FALSE;
$db['mini_warehouse']['cachedir'] = '';
$db['mini_warehouse']['char_set'] = 'utf8';
$db['mini_warehouse']['dbcollat'] = 'utf8_general_ci';
$db['mini_warehouse']['swap_pre'] = '';
$db['mini_warehouse']['autoinit'] = TRUE;
$db['mini_warehouse']['stricton'] = FALSE;
$db['mini_warehouse']['port'] = 3306;

$db['sehat_pharmacy_store']['hostname'] = 'localhost';
$db['sehat_pharmacy_store']['username'] = 'ices';
$db['sehat_pharmacy_store']['password'] = 'Ices123';
$db['sehat_pharmacy_store']['database'] = 'sehat_pharmacy_store_db';
$db['sehat_pharmacy_store']['dbdriver'] = 'mysqli';
$db['sehat_pharmacy_store']['dbprefix'] = '';
$db['sehat_pharmacy_store']['pconnect'] = FALSE;
$db['sehat_pharmacy_store']['db_debug'] = FALSE;
$db['sehat_pharmacy_store']['cache_on'] = FALSE;
$db['sehat_pharmacy_store']['cachedir'] = '';
$db['sehat_pharmacy_store']['char_set'] = 'utf8';
$db['sehat_pharmacy_store']['dbcollat'] = 'utf8_general_ci';
$db['sehat_pharmacy_store']['swap_pre'] = '';
$db['sehat_pharmacy_store']['autoinit'] = TRUE;
$db['sehat_pharmacy_store']['stricton'] = FALSE;
$db['sehat_pharmacy_store']['port'] = 3306;
