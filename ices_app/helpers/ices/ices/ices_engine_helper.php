            ...
            array(
                ...
                'app'=>array(
                    ...
                    array(
                        ...
                        'app_translate'=>false,
                        'app_default_url'=>get_instance()->config->base_url().'warehouse/dashboard',
                        'app_icon_img'=>get_instance()->config->base_url().'libraries/img/ices/warehouse.png',
                        'app_theme'=>'AdminLTE',
                        'app_db_lock_name'=>'warehouse',
                        'app_db_lock_limit'=>10,
                        'non_permission_controller'=>array(),
                        'app_info'=>'Support: +6289677006638<br/><i class="fa fa-skype text-blue"></i> purpl3girl'
                    ),
