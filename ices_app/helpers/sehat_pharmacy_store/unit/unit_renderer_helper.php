...
class Unit_Renderer {
    ...
    public static function modal_unit_render($app, $modal) {
        //<editor-fold defaultstate="collapsed">
        $modal->header_set(array('title' => Lang::get('Unit'), 'icon' => 'fa fa-cogs'));
        $modal->width_set('95%');
    ...
    public static function unit_components_render($app, $form, $is_modal) {
        ...
        $form->input_select_add()
                ...
                ->input_select_set('id', $id_prefix . '_unit_status')
        ...
        $js = get_instance()->load->view(ICES_Engine::$app['app_base_dir'] . 'unit/unit_basic_function_js', $param, TRUE);
        $app->js_set($js);
